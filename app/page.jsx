...
const Home = () => {
   // Handler untuk mengunduh file PDF
    const handleDownload = () => {
    const link = document.createElement("a");
    link.href = "/assets/Eko_Aryanto_CV.pdf"; // Ganti dengan path ke file PDF Anda
    link.download = "Eko_Aryanto_CV.pdf"; // Nama file yang akan diunduh
